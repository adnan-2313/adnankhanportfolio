...
export const skills = [
  ...
  },
  {
    ...
    title: "Programming Languages and CourseWork",
    skills: [
      {
        name: "C/C++",
        image:
     ...
     
      {
        name: "JavaScript",
        image:
          "https://www.google.com/search?q=js+logo&sca_esv=5fae2633b037e436&sca_upv=1&sxsrf=ACQVn0_ETwpK_hYOWToH0VGUNk6bolXYJQ%3A1713592108485&ei=LFcjZs2hHdS5seMPxNC8kAY&ved=0ahUKEwjN56mHjNCFAxXUXGwGHUQoD2IQ4dUDCBA&uact=5&oq=js+logo&gs_lp=&sclient=gws-wiz-serp#vhid=hDOuE3Uh0EiOSM&vssid=l",
      },
      {
        name: "Java",
      ...
      },
      {
        ...
        image:
          "https://www.shutterstock.com/image-vector/oop-object-oriented-programming-acronym-260nw-2032420412.jpg",
      },
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "../images/movierecommendation.jpg",
    tags: [
      "Python",
      "recomender system",
      "cosine similarity",
